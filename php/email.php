<?php 
    ...
    function sendEmail($recipientEmail, $request_id, $conn) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'angelosimbulan16@gmail.com'; // Consider using environment variables
            $mail->Password = 'qglw gkua lgxc szxw'; // Use environment variables or a secure storage
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;
            ...
            // Email content
            $mail->isHTML(true);
            $mail->Subject = "The Items You Requested Have Been Released (Request ID: " . htmlspecialchars($request_id) . ")";
            ...
            // If there is an error, catch the exception and return false
